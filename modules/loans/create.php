        ...
        <form method="POST" action="<?= BASE_URL ?>/modules/loans/save.php">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" name="interest_rate" class="form-control" step="0.01" min="0" max="100" value="<?= h($old['interest_rate'] ?? '0') ?>">
                        <span class="input-group-text">%</span>
                    </div>
                    <div class="form-text">Leave 0 for interest-free advance.</div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><?= PAYROLL_CURRENCY_SYMBOL ?></span>
                        <input type="number" name="monthly_deduction" class="form-control" step="0.01" min="0" value="<?= h($old['monthly_deduction'] ?? '') ?>" placeholder="0.00" required>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="notes" class="form-control" rows="2" placeholder="Optional notes…"><?= h($old['notes'] ?? '') ?></textarea>
                </div>
